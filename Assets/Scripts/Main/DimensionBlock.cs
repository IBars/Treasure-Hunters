...
public class DimensionBlock : MonoBehaviour
{
    ...
    )
    {
        ...
        if (goingInside)
        {
            if (OptimizedChunkWorldGenerator.InstanceGameObject != null)
                OptimizedChunkWorldGenerator.InstanceGameObject.SetActive(false);
        ...
        {
            if (OptimizedChunkWorldGenerator.InstanceGameObject != null)
                OptimizedChunkWorldGenerator.InstanceGameObject.SetActive(true);
